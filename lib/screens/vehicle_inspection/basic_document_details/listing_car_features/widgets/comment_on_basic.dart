...
class CommentsOnBasicDetails extends StatelessWidget {
  const CommentsOnBasicDetails({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        FeatureCheckbox(
          features:
              context.watch<UploadBasicDetailsService>().commentsOnBasicDetails,
